...
public class TrustySubjectDnParserTest {
    ...
    public void shouldValidateCertificates() {
        ...
        Assert.assertNotNull(new TrustySubjectDNParser(newGostCert.getSubjectDN()).getEmail());
        Assert.assertNotNull(new TrustySubjectDNParser(oldRsaCert.getSubjectDN()).getEmail());
        Assert.assertNotNull(new TrustySubjectDNParser(newRsaCert.getSubjectDN()).getEmail());
    }
}
