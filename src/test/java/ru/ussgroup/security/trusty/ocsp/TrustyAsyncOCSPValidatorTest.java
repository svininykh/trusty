...
public class TrustyAsyncOCSPValidatorTest {
    ...
    public void shouldValidate() throws Exception {
        ...
        TrustyOCSPValidator validator = new TrustyCachedOCSPValidator(new KalkanOCSPValidator("http://ocsp.pki.gov.kz/", repository), 5, 60);
...
//        TrustyOCSPValidationResult result = validator.validateAsync(ImmutableSet.of(kucGOST, kucRSA, nucGOST2, nucRSA2, nucGOST1, nucRSA1)).get();
        ...
        TrustyOCSPValidationResult result = validator.validateAsync(ImmutableSet.of(kucGOST)).get();
